    		...
    		<tr>
    			<td>
				    ...
				    <tr>
				      ...
				      <td>
				      <s:if test="%{articleType==1}">政务信息公开</s:if>
				      <s:elseif test="%{articleType==2}">综合资讯</s:elseif>
				      <s:elseif test="%{articleType==3}">公共法律服务</s:elseif>
				      <s:elseif test="%{articleType==4}">队伍建设</s:elseif>
					  <s:else>通知公告</s:else>
				      </td>
				      ...
				      <td>
				      <s:if test="%{articleStatus==1}">未审核</s:if>
				      <s:elseif test="%{articleStatus==2}">通过</s:elseif>
					  <s:else>不通过</s:else>
				      </td>
