...
<div>
	<h1>添加文章</h1>
	<s:form action="article!add.action" method="post">
    	<table style="width:100%">
    		<tr>
    			<td style="width:30%;text-align: right">文章名称</td>
    			<td>
    				<input type="text" size="40" name="article.articleName"/>
    			</td>
    		</tr>
    		<tr>
    			<td style="width:30%;text-align: right">审核员ID</td>
    			<td>
    				<input type="text" size="40" name="article.articleID"/>
    			</td>
    		</tr>
    		<tr>
    		...
    		<tr>
    			...
    			<td>
    			<input type="date" name="article.updateTime"/>
    			</td>
    		</tr>
    		<tr>
    		...
    		<tr>
    			...
    			<td>
    				<select name="article.articleStatus">
    		...
    		<tr>
    			...
    			<td>
    				<!--
    				<script id="editor" type="text/plain" style="width:1024px;height:500px;name="article.articleContent""></script>
    				<script id="editor" type="text/plain" style="width:1024px;height:500px;"></script>
    				<textarea id="editor"  size="40" name="article.articleContent"></textarea> 
    				-->
    				<textarea id="editor" style="width:1024px;height:500px;" name="article.articleContent"></textarea> 
