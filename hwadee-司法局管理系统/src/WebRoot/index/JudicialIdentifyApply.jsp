...
<body>
	...
	<div id="body" align="center">
		<form action="judicialidentifyapply!add.action" method="post">

			<fieldset style="width:850px;">
				<legend style="font-size:30px">申请司法鉴定</legend>
				<table width="850px" height="900px"	
					...
					<tr>
						<td><p>
							...
							<p>
								<label>申请人编号 ： <input type="text" name="jd.userNumber">
							...
							<p>
								<label>申请人地址 ： <input type="text" name="jd.jiappAdd">
							...
							<p>
								申请人生日 ： <input name="jd.jiappBirthday" type="text" size="20"><input
							...
							<p>
								申请人性别 ： <input name="jd.jiappSex" type="radio" value="man"
									checked> 男 <input type="radio" name="jd.jiappSex"
									value="woman"> 女
							</p>
							<p>
								申 请 事 项 ： <input name="claims1" type="text" value="" size="88"
									maxlength="1024">
							</p>
							<p>
								<label>理由和事实 ： <textarea name="jd.jiclaims1" cols="100"
										rows="8"></textarea>
								</label>
							</p>
							<p>
								<input type="hidden" name="jd.jistatus" value="apply"> <label
