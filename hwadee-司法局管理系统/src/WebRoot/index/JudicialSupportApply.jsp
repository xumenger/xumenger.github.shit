...
<body>
	...
	<div id="body" align="center">
		<form action="judicialsupportapply!add.action" method="post">

			<fieldset style="width:850px;">
				<legend style="font-size:30px">申请司法援助</legend>
				<table width="850px" height="900px" align="center"
					...
					<tr>
						<td>
							...
							<p>
								<label>申请人编号 ： <input type="text" name="js.UserNumber">
							...
							<p>
								<label>申请人地址 ： <input type="text" name="js.jsappAdd">
							...
							<p>
								申请人生日 ： <input name="js.jsappBirth" type="text" size="20"><input
							...
							<p>
								申请人性别 ： <input name="js.jsappSex" type="radio" value="man"
									checked> 男 <input type="radio" name="js.jsappSex"
									value="woman"> 女
							</p>
							<p>
								申 请 事 项 ： <input name="js.jsclaims" type="text" value=""
									size="88" maxlength="1024">
							</p>
							<p>
								<label>理由和事实 ： <textarea name="jd.jsfact" cols="100"
										rows="8"></textarea>
								</label>
							</p>
							<p>
								<input type="hidden" name="jd.jsstatus" value="apply"> <label
